...
const Customize: React.FC = () => {
  ...
  const handleCheckPrice = async () => {
    if (!name || !crust || !sauce || !cheese) {
      Swal.fire(
        "Error",
        "Please fill out all required fields: name, crust, cheese, and sauce.",
        "error"
      );
      return;
    }
    ...
    try {
      const response = await axios.post(
        "http://localhost:8080/api/pizzas/customize",
        {
          ...
          <div className="p-5">
            ...
            <form className="space-y-4">
              ...
              <div className="flex justify-end gap-2">
                ...
                {loading && (
                  <p className="text-blue-500">Creating your pizza...</p>
                )}
